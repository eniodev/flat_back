...
const getMoradores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const moradores = yield prisma.moradores.findMany();
        res.json(moradores);
    }
    catch (error) {
        console.error(error);
...
const getMoradorById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const modalidadePagamento = yield prisma.moradores.findUnique({ where: { id: parseInt(id) } });
...
const createMorador = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
